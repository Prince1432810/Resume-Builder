...
const TemplateOne = (props) => {
    ...
    function printExp(data) {
        ...
        return (
          ...
          <li>{data.jobSummary}</li>
                ...
                <div
                    className="text-sm pl-5 [&_ol]:list-decimal [&_ol]:pl-6 [&_ul]:list-disc [&_ul]:pl-6"
    ...
    function printCertificate(data) {
        if (!certificateData.length) return;
    ...
    return (
        <div
            ...
            className="bg-white text-black border border-[#CBDAE3] overflow-scoll no-scrollbar mx-auto p-20 rounded-lg place-self-center shadow-xl  "
        >
            ...
            <div className="flex items-center flex-col ">
                ...
                >
                    ...
                    <div
                        className="text-[.9rem] leading-4.5 text-wrap [&_ol]:list-decimal [&_ol]:pl-6 [&_ul]:list-disc [&_ul]:pl-6"
                        dangerouslySetInnerHTML={{
                ...
                <div
                    className={
                        skillsData.length
                            ? "w-full self-start h-fit mt-5 mb-5"
                            : "hidden"
                    }
                >
                    ...
                    <div className="flex flex-col gap-2 flex-wrap mt-1">
                        ...
                        <div className="flex gap-2">
                            ...
                            <div className="flex gap-2 flex-wrap items-center">
                                {primarySkillsData.map((data) =>
                                    printPrimarySkills(data),
                                )}
                            </div>
                        </div>
                        {/* Skills */}
