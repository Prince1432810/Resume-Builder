...
const SbRow = ({ iconSrc, children }) => (
  <View style={styles.sbRow}>
    {iconSrc && (
      <Image src={iconSrc} style={styles.sbRowIcon} />
    )}
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.sidebar}>
          ...
          {email && (
            <SbRow iconSrc="/Icons/mail.png">{email}</SbRow>
          )}
          {phone && (
            <SbRow iconSrc="/Icons/call.png">{phone}</SbRow>
          )}
          {(city || state || country) && (
            <SbRow iconSrc="/Icons/location.png">
              {[city, state, country].filter(Boolean).join(" , ")}
            </SbRow>
          )}
          {linkedin && (
            <SbRow iconSrc="/Icons/linkedin.png">{linkedin}</SbRow>
          )}
          ...
          {primarySkillsData.length > 0 && (
            <>
              ...
              {primarySkillsData.map((skill, idx) => (
                <View key={skill.id} style={styles.skillBarWrapper}>
                ...
                <View key={cert.id} style={styles.certRow}>
                  ...
                  <View style={styles.certIconCol}>
                    ...
                    {idx < certificateData.length - 1 && (
                      <View style={styles.certConnector} />
                    )}
                  </View>
                  {/* Text */}
                  <View
          ...
          {socialData.length > 0 && (
            <>
              ...
              <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 4 }}>
                {socialData.map((s) => (
                  <Link key={s.id} src={s.URL} style={styles.socialLink}>
                    {s.label}
                  </Link>
                ))}
              </View>
              ...
              <View style={styles.expSection}>
                {expData.map((exp, idx) => (
                  <View
                    ...
                    style={[
                      styles.expRow,
                      idx < expData.length - 1 ? styles.expSpacing : {},
                    ]}
                  >
                    ...
                    <View style={styles.expContentFlex}>
                      ...
                      {exp.jobSummary && hasContent(exp.jobSummary) && (
