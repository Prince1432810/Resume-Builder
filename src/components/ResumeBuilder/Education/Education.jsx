...
const Education = () => {
    ...
    const handleNoShow = (id) =>
        setEduData((prev) => prev.filter((item) => item.id !== id));
    ...
    return (
        <div className="">
                            ...
                            <div className="grid md:grid-cols-2 gap-x-5 gap-y-6 mb-6">
                                <div className="inputContainer">
                                    ...
                                    <input
                                        ...
                                        placeholder="university / school board"
                                    />
                                </div>
                                ...
                                <div className="inputContainer">
                                    ...
                                    <YearPicker
                                        ...
                                        onChange={(val) =>
                                            handleEditChange("endYear", val)
                                        }
                                        disabled={!editForm.startYear}
                                        minYear={
                                            editForm.startYear
                                                ? parseInt(editForm.startYear)
                                                : 1948
                                        }
                                        maxYear={
                                            editForm.startYear
                    ...
                    <div className="inputContainer">
                        <div className="flex mb-0.5 gap-1">
                            <SchoolIcon
                                ...
                                className="text-gray-500 mb-0.5"
                            />
                            <label className="labelField" htmlFor="institution">
                                Institution
                            </label>
                        </div>
                        <input
                    ...
                    <div className="inputContainer">
                        <div className="flex mb-0.5 gap-1">
                            <CardMembershipIcon
                                ...
                                className="text-gray-500 mb-0.5"
                            />
                            <label className="labelField" htmlFor="degree">
                                Degree
                            </label>
                        </div>
                        <input
            ...
            <button
                ...
                className={education ? "hidden" : "btn mt-5"}
            >
                Add Education
            </button>
        </div>
