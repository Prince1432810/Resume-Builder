    ...
    return (
        <div className="">
            <p className="text-gray-400 text-sm">
                Showcase your expertise and stay ahead—certifications prove your
                skills, boost credibility, and open doors to new opportunities.
            </p>
            ...
            >
                    ...
                    <div className="inputContainer">
                        <div className="flex mb-0.5 gap-1">
                            <WorkspacePremiumOutlinedIcon
                                ...
                                className="text-gray-500 mb-0.5"
                            />
                            <label className="labelField" htmlFor="certificate">
                                Certificate Name
                            </label>
                        </div>
                        <input
                ...
                <button
                    ...
                    className={
                        isAddFormFilled
                            ? "safe-button"
                            : "white-gray-btn cursor-not-allowed"
                    }
                >
                    Save
                </button>
            ...
            <button
                ...
                className={certificate ? "hidden" : "btn mt-5"}
            >
                Add Certificate
            </button>
        </div>
