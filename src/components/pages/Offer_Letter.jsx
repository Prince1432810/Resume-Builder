        ...
        <div className="w-full -m-1">
            ...
            <div className="mt-5 p-6 pb-13 bg-white rounded-lg">
                <div className="flex justify-between">
                    ...
                    <button className="bg-[#3985b6] p-2 pl-5 pr-5 h-11 rounded-md text-white w-auto outline-none  active:bg-[#4898ce]">
                        {" "}
                        + Create Offer Letter
                    </button>
                </div>
                        ...
                        <div className="flex justify-center p-4 border-t border-t-gray-200">
                            <div className="flex select-none ">
                                <button onClick={prevPage}>
                                    <img
                                        className="rotate-180 ml-5 mr-2 w-8 p-1.5  hover:bg-gray-200 rounded-lg transition-all duration-200 cursor-pointer"
                                        src={rightArrow}
                                        alt="prev page"
                                    />
                                </button>
                                ...
                                <button onClick={nextPage}>
                                    <img
                                        className="ml-2 w-8 p-1.5 hover:bg-gray-200 rounded-lg transition-all duration-200 cursor-pointer"
                                        src={rightArrow}
                                        alt="next page"
                                    />
                                </button>
