      ...
      <div className='flex '>
        ...
        <div className='mt-5 p-6 pb-13 bg-white rounded-lg'>
            <div className='flex justify-between'>
                <strong className='text-xl font-extrabold'>Documents</strong>
                <button className="bg-[#3985b6] p-2 h-10 rounded-md text-white w-30 outline-none text-sm font-semibold active:bg-[#4898ce]">Save in Drive</button>
            </div>
            <div className='bg-white border border-gray-200 rounded-t-lg mt-15'>
                ...
                <div className='w-full rounded-lg '>
                    ...
                    <div className='bg-white h-58 w-full flex justify-center items-center'>
                        <span className=' text-gray-500 h-fit'>No Data Available</span>
                    </div>

                    <div className='flex justify-end p-4 border-t border-t-gray-200'>
                        <span className='text-gray-500'>0-0 of 0</span>
                        <div className='flex'>
                            <img className='rotate-180 ml-5' src={rightArrow} alt="" />
